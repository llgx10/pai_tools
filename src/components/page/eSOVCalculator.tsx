...
import { Card, Row, Col, Select, Button, Table, ConfigProvider } from "antd";
...
const eSOVCalculator: React.FC = () => {
    ...
    const reChartData = React.useMemo(() => {
        ...
        return brands.map(brand => {
            ...
            return { id: brand, data: brandData };
        });
    }, [result, metric]);
    ...
    return (
        <ConfigProvider
            theme={{
                token: {
                    colorBgContainer: themeMode === "light" ? "#fff" : "#141414",
                    colorText: themeMode === "light" ? "#000" : "#fff",
                },
            }}
        >
            <div
            ...
            >
                ...
                <Row gutter={16}>
                    <Col span={12}>
                        <Card
                            title="Upload Search Files"
                            style={{
                                background: themeMode === "light" ? "#fff" : "#141414",
                                color: themeMode === "light" ? "#000" : "#fff",
                                borderColor: themeMode === "light" ? "#f0f0f0" : "#333",
                            }}
                        >
                            {[0, 1, 2].map(i => (
                                <div key={i}>
                                    <div
                                        ...
                                        style={{
                                            ...
                                            background: themeMode === "light" ? "#fafcff" : "#2a2a2a",
                                            marginBottom: 10,
                    ...
                    <Col span={12}>
                        ...
                        >
                            <UploadSection onUpload={handleSpendUpload}  themeMode={themeMode} />
                            <Select
                                style={{ width: "100%", marginTop: 12 }}
